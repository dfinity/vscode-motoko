...
const reusableMotokoInstances: Motoko[] = [];

function requestMotokoInstance(): Motoko {
    if (reusableMotokoInstances.length) {
        const motoko = reusableMotokoInstances.pop()!;
...
export function addContext(uri: string): Context {
    ...
    const motoko = requestMotokoInstance();
